...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "OneTrust CMP enhanced",
  "categories": ["MARKETING", "TAG_MANAGEMENT", "PERSONALIZATION"],
  "brand": {
    "id": "github.com_simonmadsen",
    "displayName": "OneTrustCMPenhanced",
...
[
  ...
  },
  {
    "type": "GROUP",
    "name": "Other settings",
    "displayName": "Additional privacy and alternative tracking Settings",
    "groupStyle": "NO_ZIPPY",
    "subParams": [
      {
        "type": "CHECKBOX",
